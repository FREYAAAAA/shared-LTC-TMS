...
var tblBody = document.createElement("tbody");
  ...
  Mheader1.appendChild(document.createTextNode("步驟名稱"));
  ...
  num.appendChild(document.createTextNode('順序'));
  ...
  md.appendChild(document.createTextNode("描述:"));
  ...
  uploadCol.appendChild(document.createTextNode("上傳圖片:"));
  ...
  saveBut.appendChild(document.createTextNode("儲存"));
  saveBut.setAttribute("onclick","MainstepSubmit("+j+")");
  deleteBut.appendChild(document.createTextNode("刪除"));
