    ...
    firebase.database().ref().update(updates);
      ...
      storageRef3.getDownloadURL()
       ...
       storageRef4.getDownloadURL()
        ...
        createNewAuthAccount(staffEmail,staffPassword, staffName,staffPosition);
      //   const promise = firebase.auth().createUserWithEmailAndPassword(staffEmail,staffPassword);
      //   promise.then(function(user){
      //     var bUser = 'BrowserUserInfo/'+user+'/';
      //     var pathing = staffPosition +'/'+StaffID +'/Portfolio/';
      //     firebase.database().ref(bUser).set(pathing);
         ...
         /*.then(function(user){
             if(user){
               ...
               user.updateProfile({
                 ...
                 alert('Done inputting profile!');
               }).catch(function(error){
                 alert('Failed to input profile!');
               });
             }
           })*/
  });
...
function createNewAuthAccount(staffEmail,password, staffName,staffPosition){
